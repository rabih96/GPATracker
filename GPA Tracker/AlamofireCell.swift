...
class AlamofireCell: UITableViewCell, CellHeightProvider {
    
    @IBOutlet weak var licenseLabel: UILabel!
    
    static func createCell() throws -> AlamofireCell {
        let cell: AlamofireCell = try Bundle.main.form_loadView("AlamofireCell")
