...
class SwiftyDropboxCell: UITableViewCell, CellHeightProvider {
    
    @IBOutlet weak var licenseLabel: UILabel!
    
    static func createCell() throws -> SwiftyDropboxCell {
        let cell: SwiftyDropboxCell = try Bundle.main.form_loadView("SwiftyDropboxCell")
