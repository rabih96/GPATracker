...
class MInfoViewController: FormViewController {
    ...
    public func save(_ result: FormBuilder.FormValidateResult) {
        ...
        case .valid:
            ...
            userDefaults.setValue(String(MajorName.value), forKey: "Major Name")
    ...
    lazy var MajorName: TextFieldFormItem = {
        ...
        instance.title("Major Name")
        instance.keyboardType = .asciiCapable
        instance.styleClass("textFields")
        instance.autocorrectionType = .no
        instance.submitValidate(CountSpecification.min(1), message: "Enter the major name")
