...
class SwiftRaterCell: UITableViewCell, CellHeightProvider {
    
    @IBOutlet weak var licenseLabel: UILabel!
    
    static func createCell() throws -> SwiftRaterCell {
        let cell: SwiftRaterCell = try Bundle.main.form_loadView("SwiftRaterCell")
