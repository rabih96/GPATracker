...
class SwiftyJSONCell: UITableViewCell, CellHeightProvider {

    @IBOutlet weak var licenseLabel: UILabel!
    
    static func createCell() throws -> SwiftyJSONCell {
        let cell: SwiftyJSONCell = try Bundle.main.form_loadView("SwiftyJSONCell")
